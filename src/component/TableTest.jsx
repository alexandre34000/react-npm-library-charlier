 ...
 */
export const sortList =(arr, colName, mode)=>{
 ...
 */
export const toSearchByValue =(arr, value, keyName)=>{
 ...
 */
export const toSelectPage =(pred, currentPage)=>{
 ...
 */
export const buildHeaderElement = (bodyEl, headEl)=>{
